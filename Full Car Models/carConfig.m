...
% radius (7.7 in)
carParams.cg_height = [0.300228]; % (11.82 in) % 0.300228      12in: 0.3048
carParams.roll_center_height_front = 0.0254; % 1 in (3.4 in: 0.08636) 0.0254
carParams.roll_center_height_rear = 0.03175; % 1.25 in (3.6 in: 0.09144) 0.03175
carParams.R_sf = [0.41]; % proportion of roll stiffness in front (not same as LLTD)
...
DTparams.G_d1 = [5]; % differential torque transfer offset due to internal friction
